...
$(document).ready(function () {
	...
	// 商品紹介 外壁の色選択でサムネ画像変更
	$("#outerWall_keinen").css("visibility", "hidden");
	$('[name="outerWallSelect"]:radio').change(function () {
		if ($('[id=outerWallSelect_sugi]').prop('checked')) {
			$("#outerWall_sugi").css("visibility", "visible");
			$("#outerWall_keinen").css("visibility", "hidden");
		} else if ($('[id=outerWallSelect_keinen]').prop('checked')) {
			$("#outerWall_sugi").css("visibility", "hidden");
			$("#outerWall_keinen").css("visibility", "visible");
		}
