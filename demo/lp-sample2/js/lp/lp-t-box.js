...
$(document).ready(function () {
	...
	$('[name="outerWallSelect"]:radio').change(function () {
		var imgSrc = $('#product .sectionContentWrap .thumbnailWrap .color>img').attr('src').split('/');


		// ブラック
		if ($('[id=outerWallSelect_bk]').prop('checked')) {
			var changeBk = $('#product .sectionContentWrap .thumbnailWrap .color>img').attr('src').replace(imgSrc[4], 'photo01_bk.jpg');
			$('#product .sectionContentWrap .thumbnailWrap .color>img').attr('src', changeBk);
			// グレー
		} else if ($('[id=outerWallSelect_gy]').prop('checked')) {
			var changeGy = $('#product .sectionContentWrap .thumbnailWrap .color>img').attr('src').replace(imgSrc[4], 'photo01_gy.jpg');
			$('#product .sectionContentWrap .thumbnailWrap .color>img').attr('src', changeGy);
			// ホワイト
		} else if ($('[id=outerWallSelect_wh]').prop('checked')) {
			var changeWh = $('#product .sectionContentWrap .thumbnailWrap .color>img').attr('src').replace(imgSrc[4], 'photo01_wh.jpg');
			$('#product .sectionContentWrap .thumbnailWrap .color>img').attr('src', changeWh);
			// ブラウン
		} else if ($('[id=outerWallSelect_br]').prop('checked')) {
			var changeBr = $('#product .sectionContentWrap .thumbnailWrap .color>img').attr('src').replace(imgSrc[4], 'photo01_br.jpg');
			$('#product .sectionContentWrap .thumbnailWrap .color>img').attr('src', changeBr);
			// ネイビー
		} else if ($('[id=outerWallSelect_nv]').prop('checked')) {
			var changeNv = $('#product .sectionContentWrap .thumbnailWrap .color>img').attr('src').replace(imgSrc[4], 'photo01_nv.jpg');
			$('#product .sectionContentWrap .thumbnailWrap .color>img').attr('src', changeNv);
		}
